...
interface prop {
  ListaServicios: listarServiciosHttp[];
  FechaIn: Moment;
  ListaServicioProductoSeleccionados: reservaCotizacionInterface["ServicioProducto"];
  SetListaServicioProductoSeleccionados: React.Dispatch<
    React.SetStateAction<reservaCotizacionInterface["ServicioProducto"]>
  >;
}
// estilos
...
const TablaServicioCotizacion = ({
  ...
  return (
    <div>
      <span>Lista de servicios a consumir</span>
      <div
        style={{
          display: "flex",
      ...
      >
        <MaterialTable
          title={""}
          columns={columnasListaServicioProductoEscogido}
          data={ListaServicioProductoSeleccionados}
          editable={{
      ...
      <div className={styles.MasServicios}>
        <MaterialTable
          ...
          columns={listaServiciosDisponibles}
          data={ListaServicios}
          actions={[
            {
              icon: "add",
...
const columnasListaServicioProductoEscogido: Column<any>[] = [
  {
...
const listaServiciosDisponibles: Column<any>[] = [
  {
    field: "IdServicioProducto",
    title: "IdServicioProducto",
    editable: "never",
