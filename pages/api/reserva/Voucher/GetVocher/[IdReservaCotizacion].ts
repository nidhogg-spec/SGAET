...
export default async (req: NextApiRequest, res: NextApiResponse<any>) => {
  ...
  const reservaCotizacion: any = await encontrarReservaCotizacion(
    req,
    res,
    IdReservaCotizacion as string | string[]
  );
...
const encontrarReservaCotizacion = async (
  req: NextApiRequest,
  res: NextApiResponse<any>,
  IdReservaCotizacion: string | Array<string>
) => {
  const coleccion: {
    prefijo: string;
    coleccion: string;
