...
export default async (req : NextApiRequest, res : NextApiResponse<any>) => {
    const { query : { IdOrdenServicio }} = req;
    const ordenServicio : any = await encontrarOrdenServicio(req, res, IdOrdenServicio);
    let docDefinition = {};
...
const encontrarOrdenServicio = async (req : NextApiRequest, res : NextApiResponse<any>, IdOrdenServicio : string | Array<string>) => {
    const coleccion : {
        prefijo: string,
        coleccion: string,
        keyId: string
