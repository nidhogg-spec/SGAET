...
const obtenerProgramaTuristico = async (
  req: NextApiRequest,
  ...
  await connectToDatabase().then(async (connectedObject) => {
    ...
    try {
      const inactivos: string | string[] = req.query.inactivos as
        | string
        | string[];
      const result =
        inactivos == "true"
...
const crearProgramaTuristico = async (
  req: NextApiRequest,
  res: NextApiResponse<any>
) => {
  const coleccion: {
  ...
  const programaTuristico: programaTuristicoInterface =
    req.body.ProgramaTuristico;
...
const actualizarProgramaTuristico = async (
  req: NextApiRequest,
  res: NextApiResponse<any>
) => {
  const coleccion: {
...
const eliminarProgramaTuristico = async (
  req: NextApiRequest,
  res: NextApiResponse<any>
) => {
  const coleccion: {
