...
function ProgramasTuristicos({ Columnas, Datos, APIpath, APIpathGeneral,ListaServiciosProductos }) {
  ...
  try {
    ...
    result.map((x) => {
      ...
      ListaServiciosProductos.push({
        ...
        Nombre: x["codServicio"] + " - " + x["servicio"] + " - " + x["TipoPaxs"] || null,
        Descripcion:
          "Caracteristicas: " +
          x["caracte"] || null,
        Precio: x["precioCoti"] || 0.00,
    ...
    result.map((x) => {
      ...
      ListaServiciosProductos.push({
        ...
        Nombre: x["codServicio"] + " - " + x["TipoPaxs"] + " - " + x["gremio"] || null,
        Descripcion:
          "N° Carne: " +
          x["carne"]+'; Idioma: '+x['idiomas']+'; DNI: '+x['dni'] || null,
        Precio: x["precioCoti"] || 0.00,
        Costo: x["precioConfi"] || 0.00,
        NombreProveedor: proveedor['nombre'],
        PuntajeProveedor: proveedor['porcentajeTotal']+'%' || null,
    ...
    result.map((x) => {
      ...
      ListaServiciosProductos.push({
        ...
        Nombre: x["codServicio"] + " - " + x["TipoPaxs"] + " - " + x["servicio"] || null,
        Descripcion:
          "Duracion: " +
          x["duracion"] || null,
        Precio: x["precioCoti"] || 0.00,
