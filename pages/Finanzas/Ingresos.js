...
export default function Ingresos({DatosIngreso, DatosEgreso, Reportes}){
  // console.log(DatosIngreso)
    ...
    const [datoTablaEgresoAdministrativo, setDatoTablaEgresoAdministrativo] = useState()
        ...
        <div>
          <form>
            <select 
              ...
              <option selected value="">Seleccione filtro</option>
...
export async function getStaticProps(){
    ...
    return{
      props:{
        DatosIngreso:DatosIngreso, DatosEgreso:DatosEgreso, Reportes:Reportes
      }
    }
}