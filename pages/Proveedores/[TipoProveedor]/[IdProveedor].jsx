...
import ModalProveedores_EditProv from "@/components/ComponentesUnicos/Proveedores/ModalProveedores_EditProv/ModalProveedores_EditProv";
...
export default function TipoProveedor(
  ...
  return (
    <div className={styles.mainContainer}>
      <ModalProveedores_EditProv
        open={Edicion}
        setOpen={setEdicion}
        key={IdProveedor}
        proveedor_init_info={Proveedor}
      />
        ...
        <div className={styles.buttonsContainer}>
          <button
            ...
            className={`${styles.button} ${
              Edicion ? styles.buttonCancelar : styles.buttonGuardar
            }`}
            onClick={(event) => {
              if (Edicion == false) {
                setEdicion(true);
          ...
          >
            ...
            <img
              src={
                Edicion
                  ? "/resources/close-black-18dp.svg"
                  : "/resources/edit-black-18dp.svg"
              }
            />
          </button>
            ...
            onRowUpdate: (newData, oldData) =>
              new Promise((resolve, reject) => {
                setTimeout(async () => {
                  ...
                  await axios
                    .post(props.APIpath + `/api/proveedores/${provDinamico}`, {
